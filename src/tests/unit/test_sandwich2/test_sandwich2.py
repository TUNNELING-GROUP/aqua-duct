...
from aquaduct.traj.sandwich2 import MetaReader
...
class TestMetaReader(TestCase):
    ...
    def setUp(self):
        ...
        self.mrs = []
        self.mrs.append(MetaReader(self.top,self.traj))
        self.mrs.append(MetaReader(self.top,self.traj,
                                   mode='sandwich'))

        self.expect_number_of_readers = [1,2]

        self.expect_physical_number_of_frames = [4000,4000]
