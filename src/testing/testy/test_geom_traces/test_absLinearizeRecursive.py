...
class TestAbsLinearizeRecursive(TestCase):
    ...
    #     C = [4, 2, 0]
    #     data = np.array([A, B, C])
    #     test_case = absLinearizeRecursive(0.5)
    #     self.assertTrue(isinstance(test_case.here(data), list))
    #
    # def test_here1(self):
    #     A = [0, 2, 0]
    #     B = [2, 2, 0]
    ...
    #     F = [2, 3, 2]
    #     G = [4, 3, 1]
    #     test_case = absLinearizeRecursive(0.1)
    #     out = [0, 3, 4, 5, 6]
    ...
    #     out = [0, 5, 6, 7, 8]
    #     data = np.array([A, B, C, D, E, F, G, H, I])
    #     test_case = absLinearizeRecursive(0.00)
    #     self.assertEqual(test_case.here(data), out)
    #
    # def test_here5(self):
    #     A = [0, 2, 0]
    ...
    #     test_case = absLinearizeRecursive(0.2)
    #     self.assertEqual(test_case.here(data), out)
    #
