...
raw_paths_section.add_entry(DefaultEntry(config_name="discard_singletons",
                                         ...
                                         default_values=[1],
                                         help_text="If > 0, discards paths of given lenght.",
                                         level=0))
...
inlets_clusterization_section.add_entry(DefaultEntry(config_name="max_level",
                                                     ...
                                                     level=0))
inlets_clusterization_section.add_entry(DefaultEntry(config_name="create_master_paths",
...
inlets_clusterization_section.add_entry(DefaultEntry(config_name="exclude_passing_in_clusterization",
                                                     name="exclude_passing_in_clusterization",
                                                     default_values=[True],
                                                     help_text="If set to True passing paths are not clustered with normal paths.", level=0))
inlets_clusterization_section.add_entry(DefaultEntry(config_name="add_passing_to_clusters",
                                                     name="add_passing_to_clusters",
                                                     default_values=[str()],
